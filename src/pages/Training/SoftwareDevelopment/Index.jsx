      ...
      <div>
        <div className="flex md:flex-row flex-col items-center">
          ...
          <div className="flex flex-col space-y-8 w-full md:w-[65%] p-2 self-start relative">
            ...
            <p className="p-2 text-[#101010] text-[18px] w-[95%] lg:w-[90%]">
              Looking forward to become a developer, transit into a career in
              tech or simply boost your career path, we offer Software
              development Programs across the three tracks: Front-End, Back-End
              and FullStack
            </p>
            <Link
              to={"/contact-us/training"}
        ...
        <div className="mt-10 flex md:flex-row flex-col items-center">
          <div className=" md:w-[57%]  p-2">
            <h6 className=" text-[#1877F9] text-[1rem] md:text-[1rem] lg:text-[1.5rem] p-2 md:p-1">Pricing</h6>

...
const PageNotFound = () => {
  ...
  return (
    <>
      ...
      <DefaultHelmet
        title="Page Not Found | Kinplus Technologies"
        description="Oops! The page you are looking for does not exist. Visit our homepage or go back to the previous page."
        url="https://www.kinplusgroup.com/404"

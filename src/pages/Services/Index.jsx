      ...
      <section>
          ...
          <div className="flex justify-between ">
            ...
            <div className="w-[45%] flex flex-col  gap-14">
              <p className="text-[#101010] text-[18px] leading-[138.889%] font-[400]">
                From idea to traction-generating product, we're by your side
                every step of the way, smoothing out bumps as they come with the
                intention of gaining retention and increasing Customer Lifetime
                Value.
              </p>
            </div>
          </div>
        ...
        <div className="relative flex items-center h-[500px]">
          <div className="absolute top-0 z-[999] w-[28.48875rem] h-[28.6875rem] bg-[#1877F9] text-[#F1F1F1]">
            ...
            <p className=" text-[1.25rem] ml-[5rem] mr-[1.5rem] font-medium leading-10">
          ...
          <div className="w-full ml-[300px] mr-[10px] ">
            <img src={handsonlaptop} alt="" className="h-[37.37em] w-full" />
          </div>
        </div>
      </section>

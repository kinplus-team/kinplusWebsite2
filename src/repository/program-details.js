  ...
  },
  {
    ...
    pricingCardInfo: {
      medium: {
        ...
        whatsIncluded: [
          "Training resources.",
          "Malware, phishing, social engineering, and DoS.",
          "Common cyber threats and attack vector.",
          "Understand the role of Linux as a Cybersecurity tool.",
        ],
      },
      pro: {
        courseDuration: "5 Month plan",
        ...
        whatsIncluded: [
          "Capstone projects",
          "Training resources",
          "Managing identity and access for Cybersecurity",
